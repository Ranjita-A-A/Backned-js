...
const registerUser = asyncHandler(async(req, res) => {
    ...
    if(!avatar){
        throw new ApiError(400 , "Avatar file is required here also")
    }
    ...
    return res.status(201).json(
        new ApiResponse(200,iscreated,"User Registered succesfully")
    )
...
const refreshAccessToken = asyncHandler(async(req, res) => {
    ...
    try {
        ...
        throw new ApiError(401, error?.message || "Something wrong in refreshing refreshToken")
    }
...
const updateUserCoverImage = asyncHandler(async(req, res) => {
    ...
    if(!coverImage.url){
        throw new ApiError(400, "Error while uploading user cover Image")
    }
